...
const Book = () => {
    ...
    return (
        ...
        <section id="booking-form" className="book">

            <div className="book__title">

                <h1 className='mb-4'>Забронируйте стол</h1>

                <p>Заполните форму бронирования – после обработки заявки на вашу почту придет подтверждение с информацией о визите.</p>
